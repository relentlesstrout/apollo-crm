            ...
            <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="notes" id="notes" rows="8" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-primary-500 focus:border-primary-500  :ring-primary-500 :border-primary-500" placeholder="Notes go here..."></textarea>
                    </div>
                </div>
